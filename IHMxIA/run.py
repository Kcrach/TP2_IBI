...
def run():
    ...
    for epoch in range(10):
        ...
        while not env.game.is_episode_finished():
            ...
            best_action_index, grads, x = agent.get_best_action_wGrad(state)

            mydata.append(x.cpu().detach().numpy().flatten())
